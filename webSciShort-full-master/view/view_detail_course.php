<?php
    include "../controller/con_detail_course.php";
?>
<!doctype html>
<html lang="en">
        ...
        <div class="row">
            <div class="col-lg-8">
              ...
              ?>
                    ...
                    <figure class="mb-4"><img class="img-fluid rounded" src="../data/<?=$rs2['cs_img'];?>" alt="..." />
                    </figure>
                    <!-- Post content-->
                    <section class="mb-5 course-body">
                        ...
                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-3"><i class="far fa-calendar-alt"></i>
                            ช่วงวันรับสมัคร</h5>
                        ...
                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-31"><i class="far fa-calendar-alt"></i>
                            ช่วงเวลาเรียน</h5>
                        <ul class="course-content fs-6">
                            <li>
                        ...
                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-32"><i class="far fa-clock"></i>
                            ระยะเวลาของหลักสูตร </h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_time']?>
                            </li>
                        </ul>

                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-5"><i class="fas fa-map-marker-alt"></i> สถานที่
                        </h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_location']?>
                            </li>
                        </ul>
                        ...
                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-2"><i class="fas fa-bullseye"></i> วัตถุประสงค์
                        </h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_fcourse']?>
                            </li>
                        </ul>
                        ...
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_group']?>
                            </li>
                        </ul>


                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-6"><i class="fas fa-chalkboard"></i>
                            ขอบข่ายเนื้อหา</h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_detail']?>
                            </li>
                        </ul>

                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-7"><i class="fas fa-file-alt"></i>
                            การวัดผลประเมินผล</h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_perform']?>
                            </li>
                        </ul>

                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-8"><i class="fas fa-award"></i>
                            ผลที่คาดว่าจะได้รับ</h5>
                        <ul class="course-content fs-6">
                            <li>
                                <?php echo $rs2['cs_reward']?>
                            </li>
                        </ul>

                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-11"><i class="fas fa-clipboard-list"></i> กำหนดการ
                        </h5>
                        <ul class=" course-content fs-6 contact-course">
                            <li><a href="../data/<?=$rs2['cs_schedule'];?>" target="_blank"
                                    class="orange-theme-2">ดาวน์โหลด PDF</a> </li>
                        </ul>


                        <h5 class="fw-bolder mb-4 mt-5" id="list-item-10"><i class="far fa-comments"></i>
                            สอบถามเพิ่มเติม</h5>
                        <ul class="list-inline course-content fs-6 contact-course">
                            <li class="list-inline-item"><i class="fas fa-phone-square-alt"></i> <a href="#">
                                    <?php echo $rs2['cs_phone']?>
                                </a>
                            </li>
                        </ul>
            </div>
            ...
            <div class="col-lg-4  d-none d-lg-block">
                <div id="list-example " class="list-group sticky-top ">
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-item-6"><i
                            class="fas fa-chalkboard"></i>
                        ขอบข่ายเนื้อหา</a>

                    <a class="list-group-item list-group-item-action" href="#list-item-7"><i
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-item-11"><i
                    ...
                    <div class="card-header bg-or-2 text-light">
                        <i class="fas fa-wallet "></i> ค่าลงทะเบียน
                        <?php echo $rs2['cs_wallet']?>/คน
                    </div>
