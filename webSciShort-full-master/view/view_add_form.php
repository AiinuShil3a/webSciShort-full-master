    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid px-4 px-lg-5">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand" href="#"><i class="fas fa-atom"></i> Add SC Short Courses</a>
            </div>
        </div>
    </nav>
    <br>
    <center>
        <div class="col-md-8">
            <form name="frmadd" method="post" action="../controller/con_add_course.php" enctype="multipart/form-data">
                ...
                <!---<input name="cs_year" type="hidden" id="YEAR" value="2022">-->
          ...
          <input type="submit">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input list="cs_year" name="cs_year" class="form-control">
                        <datalist id="cs_year">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input list="cs_img" name="cs_img" class="form-control">
                        <datalist id="cs_img">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input list="cs_schedule" name="cs_schedule" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="cs_time" class="form-control" id="cs_time"
                            placeholder="กรอกระยะเวลาในการเรียน">
                    </div>
                </div>
                <br>
                <div class="form-group row">
